<h2><a href="https://www.geeksforgeeks.org/problems/count-the-subset-with-sum-equal-to-k/1?_gl=1*1yk5kw8*_up*MQ..*_gs*MQ..&gclid=Cj0KCQiAhOfLBhCCARIsAJPiopNjHWc-dICZ6ZLS8dwMQRR1GEnFiKtirULztvYDSP0vaXJqLl-Y1IMaAk3xEALw_wcB&gbraid=0AAAAAC9yBkArr5ce9dKMoc97X-REOvS94">Count Subset With Target Sum II</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> and an integer <strong>k</strong>, find the count of <strong>subsets</strong> whose sum is equals to k.</span></p>
